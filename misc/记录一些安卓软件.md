...
- [TVBox](https://github.com/CatVodTVOfficial/TVBoxOSC)
    ...
    - 一些配置地址：
        - 饭太硬：http://饭太硬.top/tv
        - 自用：https://mirror.ghproxy.com/https://raw.githubusercontent.com/zhixc/CatVodTVSpider/main/config.json
        - 自用：https://ghproxy.cc/https://raw.githubusercontent.com/zhixc/CatVodTVSpider/main/config.json
    ...
    - 安卓5.0以上，takagen99 版 TVBox，2024.02.07 构建
...
- [Via](https://viayoo.com/zh-cn)
    - 极简套壳浏览器，调用的浏览器内核是安卓手机自带的 Android System Webview
    - 更新手机自带的 Android System Webview 可参考视频教程，如果手机有 root 权限的话，直接授权MT管理器进行安装即可：
        - [教大家如何手动更新Webview，本人是小米miui系统 - 哔哩哔哩](https://www.bilibili.com/video/av795409039)
    - 支持广告拦截(ABP规则订阅)、网络日志拦截url、广告标记、HTML书签导入导出、坚果webdav书签同步，超强diy自定义
    - play版apk安装包下载，需科学(魔法)上网才能下载
        - [via浏览器下载](https://apkcombo.com/via-browser/mark.via.gp)
    - 网页强制缩放的话需要搭配的脚本：
        - [强制缩放与桌面模式](https://greasyfork.org/zh-CN/scripts/450368-强制缩放与桌面模式)
        - [强制缩放1.5](https://greasyfork.org/zh-CN/scripts/447773-强制缩放1-5)
    - 长页面滚动优化、禁止恶意网页q奸剪切板 搭配脚本：
