...
- [RetroArch](https://www.retroarch.com)
    ...
    - buildbot构建下载【核心、安装包、着色器等资源】：[https://buildbot.libretro.com](https://buildbot.libretro.com)
...
- [v2rayNG](https://github.com/2dust/v2rayNG)
    - 科学(魔法)工具，v2ray、xray客户端，非常老牌的一个代理工具，稳定性不错
    - 支持分应用代理，局域网代理，订阅节点配置等功能
    - 安卓4.2以上可用，v1.6.30
        - [v2rayNG_1.6.30_armeabi-v7a.apk下载](https://github.com/2dust/v2rayNG/releases/download/1.6.30/v2rayNG_1.6.30_armeabi-v7a.apk)
    ...
    - 安卓5.0以上，v1.7.38
        - [v2rayNG_1.7.38_armeabi-v7a.apk下载](https://github.com/2dust/v2rayNG/releases/download/1.7.38/v2rayNG_1.7.38_armeabi-v7a.apk)
    ...
    - 安卓5.0以上，v1.8.18
        - [v2rayNG_1.8.18_armeabi-v7a.apk下载](https://github.com/2dust/v2rayNG/releases/download/1.8.18/v2rayNG_1.8.18_armeabi-v7a.apk)
        - [v2rayNG_1.8.18_armeabi-v7a.apk加速下载](https://ghproxy.top/https://github.com/2dust/v2rayNG/releases/download/1.8.18/v2rayNG_1.8.18_armeabi-v7a.apk)

- [ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid)
    - 科学(魔法)工具。
    - 支持 clash yml 订阅
    - **最好用的 clash 工具，会自动根据域名决定是否使用代理，这点非常给力。其他 v2ray、sing-box 系列的软件是无法做到的**
    - 支持分应用代理，局域网代理，订阅节点配置等功能
    ...
    - 节点相关的文章：
        - [ClashX-V2Ray-TopFreeProxy](https://agit.ai/ctt/ClashX-V2Ray-TopFreeProxy)
        - [proxy](https://agit.ai/jm/proxy)
        ...
        - [SingBOX](https://github.com/sarvari1378/SingBOX)
...
- [kiwibrowser](https://github.com/kiwibrowser/src.next)
    ...
    - 支持导入导出 html 书签
    - 安卓4.4~5.0，[发布地址](https://github.com/kiwibrowser/src/releases/tag/1019022375)

    - 安卓6.0以上，谷歌内核107，[发布地址](https://github.com/kiwibrowser/src.next/releases/tag/3356207093)
    ...
    - 安卓7.0以上，谷歌内核112，[发布地址](https://github.com/kiwibrowser/src.next/releases/tag/4736345870)
...
- [TVBox](https://github.com/CatVodTVOfficial/TVBoxOSC)
    ...
    - TVBox添加阿里播放器可参考的 [commit](https://github.com/takagen99/Box/commit/8046231c7a7a036482ced3e49a04b4b4e1c0d331)
...
- [cloudstream](https://github.com/recloudstream/cloudstream)
    - 需要使用的插件仓库：[https://github.com/hexated/cloudstream-extensions-hexated](https://github.com/hexated/cloudstream-extensions-hexated)
