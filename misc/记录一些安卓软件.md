...
> 用于隐藏 Magisk root，防止被监测到，Shamiko v0.7.3要求 Magisk 版本要大于26

[Shamiko v0.7.3下载](https://ghproxy.top/https://github.com/LSPosed/LSPosed.github.io/releases/download/shamiko-174/Shamiko-v0.7.3-174-release.zip)
...
> 安卓5.0以上，版本 Weekly release #20, 2023
...
[armeabi-v7a.apk加速下载](https://ghproxy.top/https://github.com/termux/termux-app/releases/download/v0.118.0/termux-app_v0.118.0+github-debug_armeabi-v7a.apk)
...
> 安卓4.4~6.0，[发布地址](https://github.com/kiwibrowser/src/releases/tag/1019022375)
...
[arm加速下载](https://ghproxy.top/https://github.com/kiwibrowser/src.next/releases/download/8265119645/com.kiwibrowser.browser-arm-8265119645-github.apk)
...
[arm64加速下载](https://ghproxy.top/https://github.com/kiwibrowser/src.next/releases/download/8265119645/com.kiwibrowser.browser-arm64-8265119645-github.apk)
...
> 猫影视大佬联合其他大佬开发的初代 TVBox，已经停更。后续接手且仍然在维护的项目是 [俊版TVBox](https://github.com/q215613905/TVBoxOS)、[takagen99版TVBox](https://github.com/takagen99/Box.git)。这两个版本支持猫影视自定义爬虫、道长drpy爬虫，python爬虫的话需要自行修改源码以支持。TVBox添加阿里播放器可参考的 [commit](https://github.com/takagen99/Box/commit/8046231c7a7a036482ced3e49a04b4b4e1c0d331)

> 另一个已经停止更新的[TV猫盒](https://github.com/chengxue2020-org/kensonmiao-Cat)

#### 猫影视/TVBoxOSC配置编辑器

[https://zhixc.github.io/CatVodTVJsonEditor](https://zhixc.github.io/CatVodTVJsonEditor)
...
> v1.5-4248，要求安卓 8.0 以上 64 位设备才能运行。
...
> 套壳浏览器，没有自带内核。依赖手机自带的 Android System Webview
...
> 支持部分油猴脚本、ABP广告拦截、网络日志、广告标记、资源嗅探等
